...
A short, informal description of a feature from the user's perspective. Focuses on what the user needs, not the details of how the system works. Written in a simple template: _"As a \[user\], I want \[goal\] so that \[benefit\]."_
